  ...
  bm.add(opts.name, {
    ...
    content: `
      ...
      <div id="ihn8" class="container-width">
        ...
        <div id="ipq3n" class="lead-title">Build your templates without codingmm
        </div>
        ...
        <div id="inqbk" class="lead-btn">Hover me
        </div>
      </div>
    </header>
        ...
        <div class="footer-container">
          <div class="foot-lists">
            ...
            <div class="foot-list">
              ...
              <div class="foot-list-item" id="i9ftgu">Community
              </div>
          ...
          <div class="form-sub">
            <div class="foot-form-cont">
              <div class="foot-form-title" id="idu71j">Subscribe
              </div>
